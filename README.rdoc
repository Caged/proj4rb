...
Proj.4 C library installed. 

Check which RUby version you have installed:
    ruby -v

If it is Ruby 1.9.2 or lower, you must install version 1.9.3:
    rvm install 1.9.3

Then select Ruby 1.9.3 as the default:
    rvm use --default 1.9.3

Before building, make sure you have the <i>jeweler</i> gem installed:
    gem install jeweler

Finally, simply invoke the build:
    rake build
